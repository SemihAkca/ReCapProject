...
try
{
    carManager.Add(new Car() { BrandId = 4, ColorId = 1, DailyPrice = 2350, ModelYear = 2014, Description = "2014 Model Volvo" });
    carManager.Add(new Car() { BrandId = 3, ColorId = 3, DailyPrice = 2500, ModelYear = 2017, Description = "2017 Model RangeRover" });
    carManager.Add(new Car() { BrandId = 1, ColorId = 1, DailyPrice = -12, ModelYear = 1990, Description = "1990 Model Bmw" });
}
catch (Exception e)
{
...
carManager.Update(new Car() { Id = 3009, BrandId = 3, ColorId = 3, DailyPrice = 2500, ModelYear = 2002, Description = "2002 Model RangeRover" });
...
carManager.Delete(new Car() { Id = 3009, BrandId = 3, ColorId = 3, DailyPrice = 2500, ModelYear = 2002, Description = "2002 Model RangeRover" });
foreach (var car in carManager.GetAll())
{
    Console.WriteLine($"{car.Id} {car.ModelYear} {car.Description}");
}
